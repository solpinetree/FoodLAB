...
<head>
	...
	<!-- CSS Files -->
	<link href="${resources}/css/login/bootstrap.min.css" rel="stylesheet" media="screen">
	<link href="${resources}/css/login/font-awesome.min.css" rel="stylesheet">
	<link href="${resources}/css/login/icon-7-stroke/css/pe-icon-7-stroke.css" rel="stylesheet">
	<link href="${resources}/css/login/animate.css" rel="stylesheet" media="screen">
	<link href="${resources}/css/login/owl.theme.css" rel="stylesheet">
	<link href="${resources}/css/login/owl.carousel.css" rel="stylesheet">

	<!-- Colors -->
	<link href="${resources}/css/login/css-index.css" rel="stylesheet" media="screen">
