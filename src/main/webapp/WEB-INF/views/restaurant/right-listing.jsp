			...
			<div class="listing__item">
				...
				<div class="listing__item__pic set-bg"
					...
					<div class="listing__item__pic__btns">
						<a
							href="javascript:drawMarker('${restaurant.address }', '${restaurant.name }')"><span
							class="icon_zoom-in_alt"></span></a> <a href="#"><span
				...
				<div class="listing__item__text">
					<div class="listing__item__text__inside">
						...
						<ul>
							<li><span class="icon_pin_alt"></span> ${ restaurant.address}
							</li>
							...
							<li><span class="icon_archive_alt"></span> 누적 리뷰수 : <text
									style="font-weight: bold;">120</text></li>
						</ul>
					</div>
			...
			<c:forEach begin="${pagination.startPage}"
				...
				<c:if test="${pagevalue=='main'}">
					<li
						...
						onclick="javascript:selectByCategory2('${idx}')"> ${idx} </a></li>
				</c:if>
				...
				<c:if test="${pagevalue=='search'}">
					<li
						class="page-item <c:out value="${pagination.currentPage == idx ? 'active' : ''}"/> "><a
						class="page-link" href="#"
						onClick="fn_pagination_search('${idx}','${search}')"> ${idx} </a></li>
				</c:if>
