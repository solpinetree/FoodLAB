        ...
        <div class="listing__item">
            ...
            <div class="listing__item__pic set-bg"
                    ...
                    <div class="listing__item__pic__btns">
                        ...
                        <c:if test="${!empty sessionScope.sessionMember.username}">
                            <script type="text/javascript">
                                if (${restaurant.memberIdsArchivingThis}.
                                includes(${sessionScope.sessionMember.id})
                                )
                                {
                ...
                <div class="listing__item__text" style="cursor:pointer"
                     onclick="location.href='${root}/restaurants/${restaurant.restaurantId}'">
                    <div class="">
                        ...
                        <ul class="listing_information">
                            ...
                            <c:if test="${!empty restaurant.tel }">
                                <li class="listing_information_margin"><span
                                        class="icon_phone"></span> ${ restaurant.tel}</li>
                            </c:if>
                            <c:if test="${empty restaurant.tel}">
                ...
                <c:if test="${pagination.previousPage}">
                    <li class="page-item">
                        ...
                        <a class="page-link" onClick="loadRestaurantsPage('${pagination.currentPage-1}','${category}')">
                            ...
                            <c:otherwise>
                            <a class="page-link"
                               onClick="loadListDivBySearchKeyword('${pagination.currentPage-1}','${search}')">
                                </c:otherwise>
                                </c:choose>
                                Previous</a>
                    </li>
                ...
                <c:forEach begin="${pagination.startPage}" end="${pagination.endPage}" var="idx">
                    <li class="page-item <c:out value="${pagination.currentPage == idx ? 'active' : ''}"/> ">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <a class="page-link"
                                   onClick="loadListDivBySearchKeyword('${idx}','${search}')"> ${idx} </a>
                            </c:otherwise>
                        </c:choose>
                    </li>
                </c:forEach>
